...
<head>
 ...
 <body>
 	...
 	<h1><a class='no-underline' href='http://nathanielvarney.com/dwa/p1'>Nathan Varney</a></h1>
 	...
 	<div id='about-me'>
 		...
 		I moved to Boston with my family after graduating from the University of South Florida. 
 		I am currently working in IT at the Harvard School of Public Health, where I get to build AV racks and fix broken equipment, computers, and dreams. 
 		In my free time I enjoy running, wandering in the hilarity of the internet, and generally fixing/building/tweaking/keeping-myself-busy-ing. 
 	...
 	<div id='project-info'>
 		...
 		<table>
 			<tr class='alt'>
 				<td>Host</td>
 				<td><a class='blacklink' href='http://asmallorange.com'>Asmallorange.com</a></td>
 			</tr>
 			<tr>
 				<td>Plan</td>
 			...
 			<tr class='alt'>
 				<td>Code Editor</td>
 				<td><a class='blacklink' href='http://www.barebones.com/products/TextWrangler/'>TextWrangler</a></td>
 			</tr>
 			<tr>
 				<td>Git Repo</td>
